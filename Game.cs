...
namespace OpenTKCube
{
    public class CubeWindow : GameWindow
    {
        ...
        private readonly float[] _vertices =
        {
            ...
            -8.5f, 1.5f, 0f,   0.3f, 0.3f, 0.3f,  // 4
            8.5f, 1.5f, 0f,    0.3f, 0.3f, 0.3f,  // 5
            8.5f, 12.5f, 0f,   0.3f, 0.3f, 0.3f,  // 6
            -8.5f, 12.5f, 0f,  0.3f, 0.3f, 0.3f,  // 7
            
            // Base del monitor - Gris
            -2f, 0f, -1f,    0.5f, 0.5f, 0.5f,    // 8
            2f, 0f, -1f,     0.5f, 0.5f, 0.5f,    // 9
            2f, 2f, -1f,     0.5f, 0.5f, 0.5f,    // 10
            -2f, 2f, -1f,    0.5f, 0.5f, 0.5f,    // 11
            
            -2f, 0f, 3f,     0.5f, 0.5f, 0.5f,    // 12
            2f, 0f, 3f,      0.5f, 0.5f, 0.5f,    // 13
            2f, 2f, 3f,      0.5f, 0.5f, 0.5f,    // 14
            -2f, 2f, 3f,     0.5f, 0.5f, 0.5f,    // 15
